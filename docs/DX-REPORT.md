...
3. **Search rank puts a same-symbol copy one rank above the native coin.** HYPE: solana `98sMhv…` rank 317, hyperevm `0xeeee…` rank 318 (market cap $68M vs $19.8B). We keep a native-coin map (ETH → ethereum `0xeeee…`, SOL, HYPE) as a workaround; a first cut mapped ETH to WETH and read "Smart Money buying ETH" off the wrong, much quieter book ($0 vs +$281K over 265 wallets).
