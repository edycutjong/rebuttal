...
- The public routes carry a spend guard (`apps/web/lib/guard.ts`): 6 checks per IP per minute, 2,000 live credits per day, then labelled fixture replays; the 200-credit agent route is POST-only, 2 per IP and 4 per day.
